...
if mo == '1':
  ...
  os.system('xdg-open https://www.facebook.com/Jubayar.Howlader')
  os.system('clear')
  print(logo2)
...
[31]  apt install figlet -y
  ...
  os.system('xdg-open https://www.facebook.com/jubayarhowl')
elif mo == '4':
  os.system('xdg-open https://github.com/gamingjubayarhowlader/gamingjubayarhowlader.git')
elif mo == '5':
  os.system('exit')
